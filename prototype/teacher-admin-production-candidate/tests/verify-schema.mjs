...
assert.ok(tables.has('participants'));
assert.ok(tables.has('receptions'));
assert.ok(tables.has('app_link_tickets'));
assert.ok(tables.has('stamp_events'));
assert.ok(tables.has('reception_audit'));
assert.ok(tables.has('spreadsheet_mirror'));
