...
2026-07-03時点: 追加先生A/Bの花6点・妖精6点は本番素材へ差し替え済みです。旧仮素材は `docs/extra-teacher-placeholder-backup-2026-07-03/` に保管し、確認一覧は `docs/extra-teacher-production-replacement-preview-2026-07-03.png` に保存しました。参加スタンプ素材も `docs/verify-production-assets-no-placeholders-2026-07-03.cjs` の検証対象に入れました。
...
- 「次の冒険」は、基本5人の指導碁が残っている間は基本5人を優先する。
- 追加先生A/Bは、基本5人の全巡が終わった後に「次の冒険」へ出る。
- 追加先生A/Bがイベント参加している日は、神社画面の「今日の先生」には表示される。
- 確認スクリプト: `docs/verify-next-adventure-primary-teachers-2026-07-03.cjs`
