...
name = 'morning-glory-siamese-cat-fairy'
...
d=ImageDraw.Draw(sheet); d.text((40,25),'Morning glory Siamese cat fairy original',fill=(80,70,55)); d.text((560,25),'Transparent candidate',fill=(80,70,55))
